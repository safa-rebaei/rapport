...
Un acteur est une abstraction d'un rôle joué par les utilisateurs du système prouvent être une personne ou un autre système qui interagissent directement avec le système à modéliser.

Notre système est utilisé par deux acteurs : l'administrateur et l'agent commercial.

\subsection*{CEO(Admin)}

C'est le propriétaires du dépôt de boissons, il détient le niveau d'accès le plus élevé du système.
...
Il s'occupe également de la consultation et de l'impression des factures.
...
\begin{figure}[H]
  \centering
  \makebox[\textwidth][c]{%
    \includegraphics[width=1.2\textwidth, height=0.93\textheight]{images/seqGlobale.png}%
  }
...
\item \textbf{Traçabilité :} le système enregistre toutes les actions importantes achevées par les utilisateurs.
...
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'utilisateur accède à la page accueil
...
\textbf{4.a. information obligatoires manquantes}
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
...
\hline
\textbf{Pré-condition(s)} & Le système d'identification est disponible \\
\hline
...
\hline
\textbf{Autre(s) scénario(s)} &
\textbf{3a. L'utilisateur demande d'annuler la déconnexion}
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
...
\hline
\textbf{Pré-condition(s)} &
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item Le CEO est connecté
  \item Au moins un agent existe dans le système
\end{itemize} \\
\hline
...
\textbf{Scénario de base :} &
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item Le CEO demande la page paramètres
...
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  ...
  \item Au moins une catégorie de produits est définie dans le système.
\end{itemize} \\
\hline
\textbf{Postcondition(s)} & Le produit est enregistré et devient disponible à la vente \\
\hline
\textbf{Scénario de base :} &
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  ...
  \item Le système enregistre le produit
  \item Le système informe l'agent que le produit est ajouté avec sucées
  \item le systéme affecté un etat au produit en fonction de la valeur de stock introduit par l'agent
\end{enumerate} \\
\hline
\textbf{Autre(s) scénario(s)} &
...
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'agent commercial est connecté
  \item Au moins un produit existe dans le système.
\end{itemize} \\
\hline
...
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'Agent commercial demande la gestion des produits.
  \item $\langle\langle$include$\rangle\rangle$ consulter produits
  ...
  \item Le système informe l'agent que le produit a été supprimé avec sucées
\end{enumerate} \\
\hline
\textbf{Autre(s) scénario(s)} &
...
\textbf{Acteur(s) :} & Agent commercial \\
\hline
\textbf{Description brève :} & Ce cas d'utilisation permet à l'Agent commercial de modifier les informations d'un produit existe dans le système (nom, catégorie, stock, prix unitaire, statut). \\
\hline
\textbf{Pré-condition(s)} &
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item Au moins un produit enregistré dans le système
  \item L'agent commercial est connecté
\end{itemize} \\
\hline
...
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'Agent commercial demande la gestion des Produits
  \item $\langle\langle$Include$\rangle\rangle$ consulter produit
  \item L'Agent commercial demande de modifier un produit
  \item Le système affiche les informations actuelles du produit
  \item L'Agent commercial modifier les informations souhaités (nom, categorie, prix unitaire, quantité)
  ...
  \item Le système enregistre la modification du produit
  \item Le système informe l'agent que le produit a été modifié avec succès
  \item le systéme affecté un etat au produit en fonction de la valeur de stock modifier par l'agent
\end{enumerate} \\
\hline
\textbf{Autres scénarios} &
\textbf{7.a information obligatoires manquantes :}
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item Le système détecte qu'il Ya des détails obligatoires manquants
  \item Le système informe l'agent de remplir les informations manquantes
  \item Le système retourne à l'étape 5 du scénario de base
\end{enumerate}
\textbf{8.a nom déjà utilisés :}
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
...
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'Agent commercial est connecté
  \item Au moins un Produit est enregistré dans le système
\end{itemize} \\
\hline
...
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  ...
  \item Le système affiche un message de confirmation indiquant que le produit a été archivé avec succès.
  \item Le système met à jour la liste des produits.
  \item le systéme affecté un etat au produit archivé
\end{enumerate} \\
\hline
\textbf{Autre(s) scénario(s) :} &
...
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  ...
  \item Le système informe l'agent que le client est ajouté avec sucées
  \item le systéme affecté un etat au client  en fonction de type  introduit par l'agent
\end{enumerate} \\
\hline
Autres scenarios : &
\textbf{6.a information obligatoire non remplis :}
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item Le système détecte qu'il Ya des détails obligatoires manquants
  \item Le système informe l'agent de remplir les informations manquantes
  \item Le système retourne à l'étape 4 du scénario de base
\end{enumerate}
\textbf{6.a Numéro de téléphone invalide (moins de 8 chiffres) :}
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  ...
  \item Le système retourne à l'étape 4 du scénario de base
\end{enumerate}
\textbf{7.a email ou numero de téléphone déjà enregistré dans le système :}
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
...
Pré-condition : &
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'agent commercial connecté
  \item Au moins un client existe dans le système
\end{itemize} \\
\hline
...
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'Agent commercial demande la gestion des Clients.
  \item $\langle\langle$Include$\rangle\rangle$ consulter Clients
  ...
  \item Le système informe l'agent que le client a été supprimé avec sucées
\end{enumerate} \\
\hline
Autre(s) scénario(s) : &
...
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  ...
  \item $\langle\langle$Extend$\rangle\rangle$ archiver Client
  \item Le CU se termine
\end{enumerate}
\textbf{6.a Annulation de confirmation de suppression}
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
...
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'agent commercial connecté
  \item Au moins un client est enregistré dans le système
\end{itemize} \\
\hline
...
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  ...
  \item L'agent commercial peut s'il désire, filtrer les clients par statut (actif, non actif, archivé)
...
Acteur : & Agent commercial \\
\hline
Description brève : & Ce cas d'utilisation permet à l'Agent commercial de modifier 
les informations d'un client qui existe dans le système (telles que : prénom, nom, 
téléphone, e-mail, adresse et ville pour une personne physique ou nom de société, 
téléphone, email, adresse, ville, matricule fiscal pour entreprise). \\
\hline
Pré-condition : &
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'agent commercial est connecté.
  \item Au moins un client est enregistré.
\end{itemize} \\
\hline
Post condition : & Les modifications effectuées au client sont enregistrées avec succès. \\
\hline
Scenario de base : &
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'Agent commercial demande la gestion des clients.
  ...
  \item L'Agent commercial modifie les informations souhaitées (nom, prénom, email, ville).
...
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'agent commercial connecté
  \item Au moins un client et au moins un produit existent dans le systéme
\end{itemize} \\
\hline
Post-condition(s) : &
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item La vente est enregistrée avec succès
  \item Stock produits mis à jour
\end{itemize} \\
\hline
Scénario de base : &
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  ...
  \item Le système enregistre la vente
  \item Le système informe l'agent que la vente enregistré avec succé
  \item le systéme affecté un etat au vente en fonction de statut par defaut (non payé)
\end{enumerate} \\
\hline
Autre(s) scénario(s) : &
\textbf{7.a. informations de ventes obligatoires manquantes}
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  ...
  \item Le système retourne à l'étape 4 du scénario de base
\end{enumerate}
\textbf{8.a Quantité supérieure au stock disponible}
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
...
Acteur : & Agent commercial \\
\hline
Description brève : & Ce cas d'utilisation permet à L'Agent commercial d'effectuer une recherche ou un filtrage sur les ventes afin d'accéder aux informations détaillées d'une vente enregistrée dans le système y compris sa facture s'elle existe \\
\hline
Précondition : &
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'agent commercial est connecté
  \item Au moins une vente enregistrée dans le système
\end{itemize} \\
\hline
...
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  ...
  \item Le système affiche les détails de la vente tels que : client, produits, quantites, total, date de création, date d'échéance, statut, sa facture et détails de facture
  \item $\langle\langle$Extend$\rangle\rangle$ Imprimer facture
  \item $\langle\langle$Extend$\rangle\rangle$ envoyer via WhatsApp
\end{enumerate} \\
\hline
Autre scenario : &
\textbf{5.a. liste filtrage vide}
...
Acteur : & Agent commercial \\
\hline
Description brève : & Ce cas d'utilisation permet à l'Agent commercial d'archiver une vente totalement payée dans le système, afin de la désactiver sans le supprimer définitivement du système \\
\hline
Pré-condition : &
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'agent commercial est connecté
...
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'agent commercial demande la gestion des ventes
  \item $\langle\langle$include$\rangle\rangle$ Consulter ventes.
  ...
  \item Le systéme archive la facture
...
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  ...
  \item Le système vérifie si toutes les informations obligatoires sont remplies et sont valides
  \item Le système Créer la facture.
  \item Le système informe l'agent que la facture ajoutée avec succès
  \item le systéme affecte un etat au facture par defaut (non payé)
\end{enumerate} \\
\hline
Autre scenario : &
...
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'agent commercial demande la gestion des ventes
  \item $\langle\langle$include$\rangle\rangle$ consulter Vente
...
\begin{itemize}[leftmargin=1.5em, topsep=0pt, itemsep=0pt, parsep=0pt]
  \item L'agent commercial est connecté
  \item Au moins une facture est créée dans le systéme
\end{itemize} \\
\hline
Post condition : &
\begin{itemize}[leftmargin=1.5em, topsep=0pt, itemsep=0pt, parsep=0pt]
  \item Mise à jour automatique du montant restant de la facture
  \item Le règlement est ajouté dans l'historique des règlements de la facture
  \item Le statut de la facture est mis à jour (payée ou partiellement-payée).
  \item Le statut de vente associé est mis à jour (payée ou partiellement-payée).
\end{itemize} \\
\hline
Scenario de base : &
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'Agent commercial demande la gestion des Factures.
  \item $\langle\langle$Include$\rangle\rangle$ consulter Factures
  ...
  \item Le système vérifie si toutes les informations obligatoires sont remplies
  \item Le système vérifie que le montant saisi n'excède pas au reste
  \item Le système enregistrer le règlement
  \item Le système met à jour le statut de facture
...
\begin{longtable}{|>{\bfseries\raggedright\arraybackslash}p{3.5cm}|p{\dimexpr\textwidth-3.5cm-4\tabcolsep-2\arrayrulewidth}|}
\hline
Titre : & Consulter Facture \\
\hline
Acteur : & Agent commercial \\
\hline
Description brève : & Ce cas d'utilisation permet à L'Agent commercial d'effectuer une recherche ou un filtrage sur les factures afin d'accéder aux informations détails d'une facture enregistrée dans le système \\
\hline
Précondition : &
\begin{itemize}[leftmargin=1.5em, topsep=0pt, itemsep=0pt, parsep=0pt]
  \item L'agent commercial est connecté
  \item Au moins une facture enregistrée
\end{itemize} \\
\hline
Post condition : & Details de facture est affiché à l'écran \\
\hline
Scenario de base : &
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'Agent commercial demande la gestion des Factures
  \item Le système recherche les factures enregistres dans le système
  \item Le système affiche la liste des Facture enregistres
  \item L'agent commercial peut s'il désire, filtrer les clients par statut (payée, non payée, partiellement payée, archivé)
  \item Si le filtre est choisi le systéme affiche les factures correspondants au filtre
  \item L'agent commercial peut s'il désire, chercher les factures dans la barre de recherche
  \item Le systéme affiche les factures correspondants
  \item L'agent commerciale peut egalement consulter les détails d'une facture souhaité
  \item Le système affiche les détails de facture tels que : réf facture, numéro de vente, nom client, montant, si existe montant payé, type, mode, date d'échéance, date de paiement, statut et reste
  \item $\langle\langle$Extend$\rangle\rangle$ Imprimer facture
  \item $\langle\langle$Extend$\rangle\rangle$ envoyer via WhatsApp
\end{enumerate} \\
\hline
...
\begin{itemize}[leftmargin=1.5em, topsep=0pt, itemsep=0pt, parsep=0pt]
  \item L'agent commercial est connecté
  \item Au moins une vente est enregistrée dans le système
\end{itemize} \\
\hline
Post-condition(s) : & La facture est archivée et n'apparaît plus dans la liste des factures affiché \\
\hline
Scenario de base : &
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'Agent commercial demande la gestion des Factures
  ...
  \item le systéme affecte un etat au facture archivé
\end{enumerate} \\
\hline
Autre(s) scenario(s) : &
...
\begin{itemize}[leftmargin=1.5em, topsep=0pt, itemsep=0pt, parsep=0pt]
  \item L'agent commercial est connecté
  \item Au moins une notification non lue existe dans le système
\end{itemize} \\
\hline
Post condition : &
\begin{itemize}[leftmargin=1.5em, topsep=0pt, itemsep=0pt, parsep=0pt]
  \item Le nombre de notifications diminue
  \item Statut de notification mis à jour en « lu »
\end{itemize} \\
\hline
Scenario de base : &
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item L'Agent commercial demande de consulter notification
  \item $\langle\langle$Include$\rangle\rangle$ Consulter Notifications
...
\begin{itemize}[leftmargin=1.5em, topsep=0pt, itemsep=0pt, parsep=0pt]
  \item L'agent commercial est connecté
  \item Au moins une notification existe dans le système
\end{itemize} \\
\hline
...
Acteur : & CEO \\
\hline
Description brève : & Ce cas d'utilisation permet au CEO de consulter les indicateurs clés de performance (KPI) ainsi que les analyses visuelles relatives aux ventes, produits et aux clients \\
\hline
...
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  ...
  \item Le systéme calcule les kpi

...
Un acteur est une abstraction d'un rôle joué par les utilisateurs du système pouvent  être une personne ou un autre système qui interagissent directement avec le système à modéliser.
...
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  ...
  \item Le système enregistre le produit avec l'etat disponible
...
\end{enumerate}
\textbf{8.a quantite de stock <= 5 :}
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  \item Le système enregistre le produit avec l'etat faible
\end{enumerate} \\
\hline
...
\begin{enumerate}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
  ...
  \item L'Agent commercial modifier les informations souhaités (nom, categorie, prix unitaire, stock)

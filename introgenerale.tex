...
Ce rapport de projet de fin d'études est organisé en cinq chapitres :
...
\begin{itemize}
    ...
    \item \textbf{Chapitre 4 --- Exploitation des données :} présente les deux composantes
    analytiques du système, à savoir la Business Intelligence avec ses tableaux de bord
    interactifs et indicateurs de performance, et l'Intelligence Artificielle à travers
    le module de prévision des ventes.

    \item \textbf{Chapitre 5 --- Implémentation :} présente l'environnement logiciel, les
